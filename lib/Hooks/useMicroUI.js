...
function useMicroUI(baseUrl, libraryName, options) {
  ...
  var renderComponent = (0, _react.useCallback)(function (ref, name, props) {
    if (window[libraryName] && window[libraryName].renderComponent) {
      window[libraryName].renderComponent(ref, name, props, _lodash.default.get(options, 'theme'));
    }
  ...
  (0, _react.useEffect)(function () {
    ...
    if (window[libraryName] && window["".concat(libraryName, "Environment")]) {
      setLibraryLoaded(true);
  ...
  return libraryLoaded ? [renderComponent, setLibraryLoaded, setBootstrapLoaded, setBootstrapError, window[libraryName]] : [null, false, false, false, null];
}
