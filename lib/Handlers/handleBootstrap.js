...
var handleBootstrap = function handleBootstrap(profile, _ref) {
  var name = _ref.name,
      assets = _ref.assets,
      api = _ref.api,
  ...
  return (/*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var manifestData, _profile, contents;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              manifestData = _fs.default.readFileSync(manifest.filepath, 'utf8'); // Retrieve the environment profiles

              _profile = environments.profiles[profile] || environments.profiles[environments.default]; // Replace the bootstrap JS placeholder tokens with permitted environment variables
